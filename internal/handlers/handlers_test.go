...
var theTests = []struct {
	...
	// 	{key: "email", value: "john_smith@gmail.com"},
	// 	{key: "phone", value: "255-255-2555"},
	// }, http.StatusOK},
}
...
func TestRepository_AvailabiliyJSON(t *testing.T) {
	// first case - rooms are not available
	postedData := url.Values{}
	postedData.Add("start", "2050-01-01")
	postedData.Add("end", "2050-01-02")
...
func TestRepositiry_ReservationSummary(t *testing.T) {
