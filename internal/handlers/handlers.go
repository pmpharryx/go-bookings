...
import (
	...
	"github.com/TheHarryFer/go-bookings/internal/driver"
	"github.com/TheHarryFer/go-bookings/internal/forms"
	"github.com/TheHarryFer/go-bookings/internal/helpers"
	"github.com/TheHarryFer/go-bookings/internal/models"
	"github.com/TheHarryFer/go-bookings/internal/render"
	"github.com/TheHarryFer/go-bookings/internal/repository"
	"github.com/TheHarryFer/go-bookings/internal/repository/dbrepo"
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		// Get the block map from the session. Loop through entire map, if we have an entry in the map that
		// does not exist in our posted data, and if the restriction id > 0, then it is a block we need to remove.
